  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-4 right-4 z-50 flex h-10 w-10 items-center justify-center rounded-full bg-neutral-900/80 text-neutral-300 ring-1 ring-red-500/30 backdrop-blur neon-glow-cyan"
      >
        {muted ? (
